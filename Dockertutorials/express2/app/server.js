...
app.get('/', (req, res) => {
    res.send('Hello World! 1: I have changed after the first docker build, without changing the package.json file, to see if docker build will use the cached package.json file and npm install, and thus only redo the app folder copy and default command');
});
